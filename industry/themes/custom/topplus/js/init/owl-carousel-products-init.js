    ...
    attach: function (context, settings) {
      $(context).find('.mt-carousel-products').once('mtowlCarouselProductsInit').each(function() {
        $(this).owlCarousel({
          ...
          autoplay: drupalSettings.topplus.owlCarouselProductsInit.owlProductsAutoPlay,
          autoplayTimeout: drupalSettings.topplus.owlCarouselProductsInit.owlProductsEffectTime,
          nav: true,
          dots: false,
          loop: true,
