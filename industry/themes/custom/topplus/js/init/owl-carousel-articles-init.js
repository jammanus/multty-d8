    ...
    attach: function (context, settings) {
      $(context).find('.mt-carousel-articles').once('mtOwlCarouselArticlesInit').each(function() {
        $(this).owlCarousel({
          ...
          autoplay: drupalSettings.topplus.owlCarouselArticlesInit.owlArticlesAutoPlay,
          autoplayTimeout: drupalSettings.topplus.owlCarouselArticlesInit.owlArticlesEffectTime,
          nav: true,
          dots: true,
          loop: true,
