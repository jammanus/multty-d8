...
jQuery(document).ready(function($) {
  var slideout = new Slideout({
    ...
    'padding': 300,
    'tolerance': 70,
    'side': drupalSettings.topplus.slideoutInit.slideoutSide,
    'touch': drupalSettings.topplus.slideoutInit.slideoutTouchSwipe
  });
    ...
    attach: function (context, settings) {
      $(context).find('.mt-carousel-testimonials').once('mtowlCarouselTestimonialsInit').each(function() {
        $(this).owlCarousel({
          ...
          autoplay: drupalSettings.topplus.owlCarouselTestimonialsInit.owlTestimonialsAutoPlay,
          autoplayTimeout: drupalSettings.topplus.owlCarouselTestimonialsInit.owlTestimonialsEffectTime,
          nav: true,
          dots: true,
          loop: true,
          navText: false
    ...
    attach: function (context, settings) {
      $(context).find('.mt-carousel-promoted-posts').once('mtowlCarouselPromotedPostsInit').each(function() {
        $(this).owlCarousel({
          ...
          autoplay: drupalSettings.topplus.owlCarouselPromotedPostsInit.owlPromotedPostsAutoPlay,
          autoplayTimeout: drupalSettings.topplus.owlCarouselPromotedPostsInit.owlPromotedPostsEffectTime,
          nav: true,
          dots: false,
          loop: true,
          navText: false
