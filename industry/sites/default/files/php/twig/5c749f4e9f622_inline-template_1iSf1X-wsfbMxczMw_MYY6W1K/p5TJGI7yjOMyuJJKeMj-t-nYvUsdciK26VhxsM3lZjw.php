...
<a href="{{ path }}" class="button">{{"Buy Now"|t}} <i class="fa fa-angle-right"></i></a>
</div>
</div> */
class __TwigTemplate_e9f5dabafd9616d7bf68a9bdf27436267e29a8eecc6fbe07374c77863f4f8c72 extends Twig_Template
{
...
<a href=\"";
        ...
        echo "\" class=\"button\">";
        echo $this->env->getExtension('Twig_Extension_Sandbox')->ensureToStringAllowed($this->env->getExtension('Drupal\Core\Template\TwigExtension')->renderVar(t("Buy Now")));
